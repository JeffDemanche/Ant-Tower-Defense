...
/**
 * <p>
 * A Perlin noise generation utility. Construct the PerlinNoise object with the
 * specified parameters and make a call to the
 * {@link #getHeight(double, double)} method.
 * </p>
 * 
 * <p>
 * This class does not make use of the <i>Random</i> class.
 * </p>
 * 
...
public class PerlinNoise {
	 ...
	 * @param octaves
	 */
	public PerlinNoise(int seed, double persistence, double frequency,
			double amplitude, int octaves) {
	 ...
	 */
	public final void set(int seed, double persistence, double frequency,
			double amplitude, int octaves) {
